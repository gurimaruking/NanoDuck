...
設計した。**外装を付けた結果ちょうど 76 %** — 印刷部品を実際に作ったら構造材が
33 g → 65 g になり、余裕 62 % を使い切った。
**「見た目クリソツ」の代償は 43 g と関節余裕 14 ポイント**（[cad/print/README.md](cad/print/README.md)）。

高さが 65 % にしか下がらないのは、**サーボと電池が縮まないから**（§2）。
...
代償は歩幅と地上高で、屋内 162 mm のロボットなら払える。
